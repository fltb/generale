...
vi.mock("@solidjs/router", () => ({
  ...
  useLocation: () => ({ pathname: "/game/room-123" }),
  useParams: () => ({ id: "room-123" }),
  useNavigate: () => vi.fn(),
}));

vi.mock("~/routes/games/generale/hooks/useRoomSession", () => ({
  useRoomSession: () => ({
    error: () => null,
    loading: () => false,
    needsPassword: () => false,
...
vi.mock("~/routes/games/generale/components/game/Game", () => ({
  default: () => <div data-testid="game-component">GameWithSync</div>,
}));

vi.mock("~/routes/games/generale/components/room/ConnectedRoom", () => ({
