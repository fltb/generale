...
const LogoIcon: Component<LogoIconProps> = (props) => {
  ...
  return (
    <svg width={s()} height={s()} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="image-rendering:pixelated" role="img" aria-label="General E logo">
      <title>General E</title>
