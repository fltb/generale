...
export type SyncedGameClientPlayerOperationClancelAllAction =
  SyncedStateClientGenericSyncAction<SyncedGameClientActionTypes.CLEAN_ALL>;

export type SyncedGameClientSurrenderAction = SyncedStateClientGenericSyncAction<SyncedGameClientActionTypes.SURRENDER>;
...
export {
  SyncedStateServerEventType as SyncedGameServerEventType,
  SyncedStateServerStateUpdatePayloadType as SyncedGameServerStateUpdatePayloadType,
