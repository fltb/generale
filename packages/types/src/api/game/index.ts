...
// --- reusable primitives ---
export const gameStatusSchema = t.Union([t.Literal("lobby"), t.Literal("in-progress"), t.Literal("finished")]);
export type HttpGameStatus = Static<typeof gameStatusSchema>;

export const standardMapSizeSchema = t.Union([t.Literal("small"), t.Literal("medium"), t.Literal("large")]);
...
export const mapSizeSchema = t.Union([standardMapSizeSchema, customMapSizeSchema]);
...
export const listGamesQuerySchema = t.Composite([gameListFilterSchema, gameListSortSchema, gameListPaginationSchema]);
