...
describe('UserService', () => {
  ...
  describe('User CRUD Operations', () => {
    ...
    it('should find a user by id', async () => {
      const dbRow = { id: 'user-1', username: 'tester', email: 'e@e.com', password: 'hash', verified: 1, createdAt: Date.now(), updatedAt: Date.now() };
    ...
    it('should find a user by username', async () => {
      const dbRow = { id: 'user-1', username: 'tester', email: 'e@e.com', password: 'hash', verified: 0, createdAt: Date.now(), updatedAt: Date.now() };
      mockDb.get.mockResolvedValue(dbRow);
    ...
    it('should update a user password', async () => {
        const hashSpy = vi.spyOn(userService as any, 'hashPassword');
