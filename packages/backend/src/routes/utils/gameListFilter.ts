import type { GameInfoSuccessResp, ListGamesQuery } from "@generale/types/dist/api";

export function applyGameFilters(games: GameInfoSuccessResp["data"][], query: ListGamesQuery) {
  let result = games;
